  ...
  return (
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-brand">
          ...
          <div className="footer-contact">
            <p>
              <FaMapMarkerAlt className="footer-icon" /> 📍 Ambatisatram Road, Vizianagaram, Andhra Pradesh, India
            </p>
            <p>
              <FaPhoneAlt className="footer-icon" /> 📞 +91 8008644932
            </p>
            <p>
              <FaEnvelope className="footer-icon" /> ✉️ contact@pavanphotography.com
            </p>
          </div>
        ...
        <div className="footer-social">
          ...
          <div className="social-icons">
            ...
            <a href="https://wa.me/918008644932" target="_blank" rel="noopener noreferrer"><FaWhatsapp /></a>
      ...
      <div className="footer-bottom">
        <p>© {new Date().getFullYear()} Pavan Photography. All Rights Reserved.</p>
      </div>
    </footer>
  );
};
